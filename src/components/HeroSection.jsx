  ...
  return (
    <div className="flex flex-col items-center-mt-6 lg:mt-20">
        ...
        <div className="flex justify-center my-10">
            <a href="#" className='bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md hover:from-orange-400 hover:to-orange-700'>Start for free</a>
            <a href="#" className="py-3 px-4 border rounded-md hover:bg-neutral-800 hover:border-neutral-400">Documentation</a>
        </div>
