        ...
        <div className="container px-4 mx-auto relative text-sm">
            <div className="flex justify-between items-center">
                ...
                <div className="hidden lg:flex justify-center space-x-3 items-center">
                    <a href="#" className="py-2 px-3 border rounded-md hover:bg-neutral-800 hover:border-neutral-400">Sign In</a>
                    <a href="#" className="bg-gradient-to-r from-orange-500 to-orange-800 py-2 px-3 rounded-md hover:from-orange-400 hover:to-orange-700">Create an account</a>
                </div>
